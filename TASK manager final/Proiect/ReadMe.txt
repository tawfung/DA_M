================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : Proiect Project Overview
===============================================================================

The application wizard has created this Proiect application for 
...
Proiect.h
    ...
    project specific headers and declares the CProiectApp application class.
...
ProiectDlg.h, ProiectDlg.cpp - the dialog
    These files contain your CProiectDlg class.  This class defines
